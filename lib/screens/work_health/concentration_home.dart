...
import 'package:quiz_app/screens/work_health/concentration_techniques/app-usage.dart';
                ...
                children: [
                  ...
                  Column(
                      children: [
                        ...
                        BuildCard(4, 'https://img.freepik.com/free-vector/people-using-their-mobile-phones-news_52683-39976.jpg?w=2000', 'Track App Usages', "Monitor screen time for apps to limit excessive usage, try it for setting goals on screen time for each app!", context)
                      ]
                  )
                ],
              ),

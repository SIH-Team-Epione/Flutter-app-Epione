...
final sounds = <Audio>[
    Audio.network(
      ...
      metas: Metas(
        ...
        album: "White Noise",
        image: MetasImage.network("https://www.99images.com/download-image/869224/2880x2560")
      )
    ),
    Audio.network(
        ...
        metas: Metas(
            ...
            image: MetasImage.network("https://music2relax.com/wp-content/uploads/2018/05/rsz_theraputic_binural_beats.jpg")
        )
    ),
    Audio.network(
        ...
        metas: Metas(
            ...
            image: MetasImage.network("https://iasbaba.com/wp-content/uploads/2022/01/Mindfulness.png")
        )
    ),
];
